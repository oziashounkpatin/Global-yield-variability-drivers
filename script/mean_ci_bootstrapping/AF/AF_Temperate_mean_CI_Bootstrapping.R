...
df_temperate<-read_xlsx("./input/data/all_dis_cov3.xlsx",guess_max = 1000) %>%
    filter(key %in% c("AF"), !Crop_Group %in% c("Grass"),kg_clim %in% c("Temperate"))%>%
...
#---@ for the wrb
li_wrb<-split(df_temperate$effectSize,df_temperate$wrb)
...
# final_df_new <-read_xlsx("./output/mean_ci/AF_clim/arng_AF_Temperate_mean_ci1.xlsx")
# final_df_new
#   
# # load for the graph
final_df1 <- final_df %>%
              slice(30,29,28:26,20:18,25,22,21,24,23,17,16,15,14,
                    13:1) %>%
...
write_xlsx(df_bind2,"./output/mean_ci/AF_clim/AF_Temperate_mean_ci.xlsx")
write_xlsx(final_df,"./output/mean_ci/AF_clim/arng_AF_Temperate_mean_ci.xlsx")
write_xlsx(final_df1,"./output/mean_ci/AF_clim/arng_AF_Temperate_mean_ci_sliced.xlsx")
...
# ggsave(fig1, filename = "./output/graphs/AF_clim/arid/AF_Temperate_figure.png", width = 10, height = 15, dpi = 300, units = "cm")
# ggsave(fig1, filename = "./output/graphs/AF_clim/arid/AF_Temperate_figure.pdf", width = 10, height = 15, dpi = 300, units = "cm")
# ggsave(hist_nt, filename = "./output/graphs/AF_Temperate_hist.png", width = 7, height = 10, dpi = 300, units = "cm")
# 
# # #Get covariate data
