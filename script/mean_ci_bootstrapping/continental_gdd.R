...
ggsave(plt_continental,filename = "./Next_Article/output/graphs/recap/continental/continental_gdd.png",
       width = 30,height = 18.5,
       dpi = 300, units = "cm")
 
ggsave(plt_continental,filename = "./Next_Article/output/graphs/recap/continental/continental_gdd.pdf",
       width = 45,height = 55,
       dpi = 300, units = "cm")
