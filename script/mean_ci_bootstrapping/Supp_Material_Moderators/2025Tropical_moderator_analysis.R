...
comb_all<-bind_rows(comb_crops,comb_aridity,comb_pH,comb_soc,
                    ...
                    as.data.frame()
write_xlsx(comb_all,"./output/mean_ci/df_supp_mat4.xlsx")
...
ggsave(plt_Tropical,filename = "./output/graphs/supp_mat_4.png",
       width = 45,height = 75,
       dpi = 300, units = "cm")
 
ggsave(plt_Tropical,filename = "./output/graphs/supp_mat_4.pdf",
       width = 45,height = 65,
       dpi = 300, units = "cm")
