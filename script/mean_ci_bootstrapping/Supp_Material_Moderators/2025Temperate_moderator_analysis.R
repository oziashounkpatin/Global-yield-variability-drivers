...
comb_all<-bind_rows(comb_crops,comb_aridity,comb_pH,comb_soc,
                    ...
                    as.data.frame()
write_xlsx(comb_all,"./output/mean_ci/df_supp_mat3.xlsx")
...
ggsave(plt_Temperate,filename = "./output/graphs/supp_mat_3.png",
       width = 45,height = 75,
       dpi = 300, units = "cm")
 
ggsave(plt_Temperate,filename = "./output/graphs/supp_mat_3.pdf",
       width = 45,height = 65,
       dpi = 300, units = "cm")
