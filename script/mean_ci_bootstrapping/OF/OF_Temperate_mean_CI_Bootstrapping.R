...
df_temperate<-read_xlsx("./input/data/all_dis_cov3.xlsx",guess_max = 1000) %>%
    filter(key %in% c("OF"), !Crop_Group %in% c("Grass"),kg_clim %in% c("Temperate"))%>%
...
cat<-c("Maize","Rice","V_F_others","Wheat")
...
cat<-c("GDD_rice2","GDD_rice3","GDD_rice4")
...
final_df1 <- final_df %>%
              slice(44,43,42,40,41,39:36,29,28,35,32:30,34,33,27:25,
                    24,23,22:1) %>%
...
write_xlsx(df_bind2,"./output/mean_ci/OF_clim/OF_Temperate_mean_ci.xlsx")
write_xlsx(final_df,"./output/mean_ci/OF_clim/arng_OF_Temperate_mean_ci.xlsx")
write_xlsx(final_df1,"./output/mean_ci/OF_clim/arng_OF_Temperate_mean_ci_sliced.xlsx")
...
# ggsave(fig1, filename = "./output/graphs/OF_clim/arid/OF_Temperate_figure.png", width = 10, height = 15, dpi = 300, units = "cm")
# ggsave(fig1, filename = "./output/graphs/OF_clim/arid/OF_Temperate_figure.pdf", width = 10, height = 15, dpi = 300, units = "cm")
# ggsave(hist_nt, filename = "./output/graphs/hist/OF_Temperate_hist.png", width = 7, height = 10, dpi = 300, units = "cm")
# 
# # save the data and plots
# write_xlsx(df_bind3,"./output/mean_ci/OF_clim/OF_Temperate_mean_ci.xlsx")
# write_xlsx(final_df,"./output/mean_ci/OF_clim/arng_OF_Temperate_mean_ci.xlsx")
# 
# # save the data and plots
