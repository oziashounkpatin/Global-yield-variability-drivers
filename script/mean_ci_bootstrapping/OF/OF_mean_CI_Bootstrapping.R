...
cat<-c("Cash crop","Cereal","Maize","Rice","Soybean","V_F_others","Wheat")
...
ggsave(fig1, filename = "./output/graphs/all/OF_figure.png", width = 10, height = 15, dpi = 300, units = "cm")
ggsave(hist_of, filename = "./output/graphs/hist/OF_histF.png", width = 7, height = 10, dpi = 300, units = "cm")

# save the data and plots
write_xlsx(df_bind1,"./output/mean_ci/OF_mean_ci.xlsx")
...
b_of<-p8+p9+p10+p11+p12+p13+p14+
  plot_layout(heights = c(0.40,0.40, 0.40,0.40,
                          0.50,0.50,0.50,0.50,
                          0.50,0.50),
                         ncol =1)

ggsave(a_of,filename = "./output/graphs/OF_clim/overall/OF_all1.png",
       width = 10, height = 19, dpi = 300, units = "cm")
ggsave(b_of,filename = "./output/graphs/OF_clim/overall/OF_all2.png",
       width = 10, height = 19, dpi = 300, units = "cm")
...
# ggsave(a_p1,filename = "./output/graphs/OF_clim/overall/of_a_p1.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p2,filename = "./output/graphs/OF_clim/overall/of_a_p2.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p3,filename = "./output/graphs/OF_clim/overall/of_a_p3.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p4,filename = "./output/graphs/OF_clim/overall/of_a_p4.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p5,filename = "./output/graphs/OF_clim/overall/of_a_p5.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p6,filename = "./output/graphs/OF_clim/overall/of_a_p6.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p7,filename = "./output/graphs/OF_clim/overall/of_a_p7.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p8,filename = "./output/graphs/OF_clim/overall/of_a_p8.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p9,filename = "./output/graphs/OF_clim/overall/of_a_p9.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p10,filename = "./output/graphs/OF_clim/overall/of_a_p10.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p11,filename = "./output/graphs/OF_clim/overall/of_a_p11.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p12,filename = "./output/graphs/OF_clim/overall/of_a_p12.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p13,filename = "./output/graphs/OF_clim/overall/of_a_p13.png",
#        width = 10, height = 19, dpi = 300, units = "cm")
# 
# ggsave(a_p14,filename = "./output/graphs/OF_clim/overall/of_a_p14.png",
#        width = 10, height = 19, dpi = 300, units = "cm")

# save sub data separately
write_xlsx(final_df,"./output/mean_ci/OF_clim/OF_mean_ci_plot_data.xlsx")
