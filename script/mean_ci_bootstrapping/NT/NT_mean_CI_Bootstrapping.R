...
# Bind alls
df_all<-bind_rows(all,crop, soc,bd,p,tex,dem,slope,
...
fig1<- final_df %>%
  ...
  geom_vline(xintercept=c(4.5, 8.5,13.5,18.5,22.5,26.5,
...
ggsave(fig1, filename = "./output/graphs/all/NT_figure.png", width = 10, height = 15, dpi = 300, units = "cm")
ggsave(hist_nt, filename = "./output/graphs/hist/NT_hist.png", width = 7, height = 10, dpi = 300, units = "cm")
...
write_xlsx(final_df,"./output/mean_ci/NT_clim/NT_mean_ci_plot_data.xlsx")
