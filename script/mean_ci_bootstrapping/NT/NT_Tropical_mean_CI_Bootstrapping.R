...
cat<-c("GDD_soybean4","GDD_soybean5")
...
final_df1 <- final_df %>%
              slice(58,56,54,53,51,55,57,52,50:48,39:37,47:45,42:40,44,43,36:34,33:31,30:1) %>%
...
write_xlsx(df_bind2,"./output/mean_ci/NT_clim/NT_Tropical_mean_ci.xlsx")
write_xlsx(final_df,"./output/mean_ci/NT_clim/arng_NT_Tropical_mean_ci.xlsx")
write_xlsx(final_df1,"./output/mean_ci/NT_clim/arng_NT_Tropical_mean_ci_sliced.xlsx")
...
# ggsave(fig1, filename = "./output/graphs/NT_clim/NT_Tropical_figure.png", width = 10, height = 15, dpi = 300, units = "cm")
# ggsave(hist_nt, filename = "./output/graphs/hist/NT_Tropical_hist.png", width = 7, height = 10, dpi = 300, units = "cm")
# 
# # save the data and plots
# write_xlsx(df_bind3,"./output/mean_ci/NT_clim/NT_Tropical_mean_ci.xlsx")
# write_xlsx(final_df,"./output/mean_ci/NT_clim/arng_NT_Tropical_mean_ci.xlsx")
# 
# # save the data and plots
