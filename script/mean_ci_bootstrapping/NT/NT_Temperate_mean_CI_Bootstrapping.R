...
df_tempertate<-read_xlsx("./input/data/all_dis_cov3.xlsx",guess_max = 1000) %>%
...
summary(factor(df$gdd_wheat_class))
df_wheat<-df %>% filter(!gdd_wheat_class %in% c("2"))
summary(factor(df_wheat$gdd_wheat_class))
li_gdd_wheat_class<-split(df$effectSize,df_wheat$gdd_wheat_class)
...
#---@ for the wrb
li_wrb<-split(df_tempertate$effectSize,df_tempertate$wrb)
...
final_df1 <- final_df %>%
              slice(84,82,80,79,77,81,83,78,76:73,63:61,72:70,66:64,69:67,60:58,
                    57:55,54:1) %>%
...
write_xlsx(df_bind2,"./output/mean_ci/NT_clim/NT_Tempertate_mean_ci.xlsx")
write_xlsx(final_df,"./output/mean_ci/NT_clim/arng_NT_Tempertate_mean_ci.xlsx")
write_xlsx(final_df1,"./output/mean_ci/NT_clim/arng_NT_Tempertate_mean_ci_sliced.xlsx")
...
fig1<- final_df1 %>%
  ...
  # geom_vline(xintercept=c(4.5, 9.5,13.5,18.5,20.5,24.5,
  #                         27.5,30.5,33.5,36.5,39.5,42.5, 49.5),linewidth=0.25)+
...
# ggsave(fig1, filename = "./output/graphs/NT_clim/NT_Tempertate_figure.png", width = 10, height = 15, dpi = 300, units = "cm")
# ggsave(hist_nt, filename = "./output/graphs/hist/NT_Tempertate_hist.png", width = 7, height = 10, dpi = 300, units = "cm")
# 
# # save the data and plots
# write_xlsx(df_bind3,"./output/mean_ci/NT_clim/NT_Tempertate_mean_ci.xlsx")
# write_xlsx(final_df,"./output/mean_ci/NT_clim/arng_NT_Tempertate_mean_ci.xlsx")
# 
# # save the data and plots
...
#                          ncol =1)
# 
# ggsave(a_nt,filename = "./output/graphs/NT_clim/arid/overall/NT_all1.png",
