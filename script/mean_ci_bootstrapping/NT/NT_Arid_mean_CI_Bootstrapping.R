...
final_df1 <- final_df %>%
              slice(74,72,70,69,67,71,73,68,66:65,55:53,64:62, 58:56,
                    61:59,52:50,46:1) %>%
...
write_xlsx(df_bind2,"./output/mean_ci/NT_clim/NT_Arid_mean_ci.xlsx")
write_xlsx(final_df,"./output/mean_ci/NT_clim/arng_NT_Arid_mean_ci.xlsx")
write_xlsx(final_df1,"./output/mean_ci/NT_clim/arng_NT_Arid_mean_ci_sliced.xlsx")
...
# ggsave(fig1, filename = "./output/graphs/NT_clim/NT_Arid_figure.png", width = 10, height = 15, dpi = 300, units = "cm")
# ggsave(hist_nt, filename = "./output/graphs/hist/NT_Arid_hist.png", width = 7, height = 10, dpi = 300, units = "cm")
# 
# # save the data and plots
# write_xlsx(df_bind3,"./output/mean_ci/NT_clim/NT_Arid_mean_ci.xlsx")
# write_xlsx(final_df,"./output/mean_ci/NT_clim/arng_NT_Arid_mean_ci.xlsx")
# 
# # save the data and plots
